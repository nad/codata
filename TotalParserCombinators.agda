...
∂-complete {t = t} t∷s∈ = ∂-complete′ _ t∷s∈ refl
  ...
  ∂-complete′ (p₁ · ⟨ p₂ ⟩) (_·_ {._ ∷ _} ∈₁ ∈₂) refl = ∣ˡ (∂?-complete p₁ ∈₁ · cast refl (sym (♭?♯? (∂?n p₁ t))) ∈₂)
  ∂-complete′ (p₁ · ⟪ p₂ ⟫) (_·_ {[]}     ∈₁ ∈₂) refl with ⇒ ∈₁
  ∂-complete′ (p₁ · ⟪ p₂ ⟫) (_·_ {[]}     ∈₁ ∈₂) refl | ()
  ∂-complete′ (p₁ · ⟪ p₂ ⟫) (_·_ {._ ∷ _} ∈₁ ∈₂) refl = ∂?-complete p₁ ∈₁ · cast refl (sym (♭?♯? (∂?n p₁ t))) ∈₂
