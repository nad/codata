...
data _≤_ : ∀ {m n} → Ty m → Ty n → Set where
  ...
  unfold : ∀ {n} (τ₁ τ₂ : Ty (suc n)) →
           let τ = ν τ₁ ⟶ τ₂ in τ ≤ (τ₁ [0≔ τ ]) ⟶ (τ₂ [0≔ τ ])
  fold   : ∀ {n} (τ₁ τ₂ : Ty (suc n)) →
           let τ = ν τ₁ ⟶ τ₂ in (τ₁ [0≔ τ ]) ⟶ (τ₂ [0≔ τ ]) ≤ τ
...
complete (ν σ₁ ⟶ σ₂) (τ₁ ⟶ τ₂) (τ₁≤σ₁ ⟶ σ₂≤τ₂) =
  (ν σ₁ ⟶ σ₂)                                  ≤⟨ unfold σ₁ σ₂ ⟩
  (σ₁ [0≔ ν σ₁ ⟶ σ₂ ]) ⟶ (σ₂ [0≔ ν σ₁ ⟶ σ₂ ])  ≤⟨ complete₁ ⟶ complete₂ ⟩
  τ₁ ⟶ τ₂                                      ∎
  where complete₁ = ♯ complete τ₁ (σ₁ [0≔ ν σ₁ ⟶ σ₂ ]) (♭ τ₁≤σ₁)
        complete₂ = ♯ complete (σ₂ [0≔ ν σ₁ ⟶ σ₂ ]) τ₂ (♭ σ₂≤τ₂)
complete (ν σ₁ ⟶ σ₂) (ν τ₁ ⟶ τ₂) (τ₁≤σ₁ ⟶ σ₂≤τ₂) =
  (ν σ₁ ⟶ σ₂)                                  ≤⟨ unfold σ₁ σ₂ ⟩
  (σ₁ [0≔ ν σ₁ ⟶ σ₂ ]) ⟶ (σ₂ [0≔ ν σ₁ ⟶ σ₂ ])  ≤⟨ complete₁ ⟶ complete₂ ⟩
  (τ₁ [0≔ ν τ₁ ⟶ τ₂ ]) ⟶ (τ₂ [0≔ ν τ₁ ⟶ τ₂ ])  ≤⟨ fold τ₁ τ₂ ⟩
  ν τ₁ ⟶ τ₂                                    ∎
  where complete₁ = ♯ complete (τ₁ [0≔ ν τ₁ ⟶ τ₂ ]) (σ₁ [0≔ ν σ₁ ⟶ σ₂ ]) (♭ τ₁≤σ₁)
        complete₂ = ♯ complete (σ₂ [0≔ ν σ₁ ⟶ σ₂ ]) (τ₂ [0≔ ν τ₁ ⟶ τ₂ ]) (♭ σ₂≤τ₂)
